...
try{
    ...
    $handle_pie = $link->prepare("SELECT Count(school_year.school_year) as y, UPPER(CONCAT(feeder_data.feeder_type, ' ', 'SY1920-SHS')) as x FROM school_year INNER JOIN feeder_data ON school_year.school_year_id = feeder_data.feeder_school_year Where school_year.school_year Like '%SY1920-SHS%' GROUP BY feeder_data.feeder_type"); 
    $handle_pie->execute(); 
...
var visitorsData = {
	"Public Vs Private SY1920-SHS": [{
		click: visitorsChartDrilldownHandler,
		cursor: "pointer",
		explodeOnClick: false,
		innerRadius: "75%",
		legendMarkerType: "square",
		name: "Public Vs Private SY1920-SHS",
		radius: "100%",
		showInLegend: true,
		startAngle: 90,
		type: "doughnut",
...
var newVSReturningVisitorsOptions = {
	...
	theme: "light3",
	title: {
		text: "Public Vs Private SY1920-SHS"
	},
	legend: {
		fontFamily: "calibri",
		fontSize: 14
...
chart.options.data = visitorsData["Public Vs Private SY1920-SHS"];
chart.render();
